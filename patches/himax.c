...
extern void i2c_16write8(char dev, int addr, char data);
extern char i2c_16read8 (char dev, int addr);
extern int  i2c_16read16 (char dev, int addr);
extern void i2c_delay(int);
static rt_i2c_t __i2c;
  ...
  //    if (is_i2c_active())
    {
        ...
        i2c_16write8(0x24,addr,i2c_req.wr.value);
