...
#if PULP_CHIP == CHIP_QUENTIN || PULP_CHIP == CHIP_KERBIN || PULP_CHIP == CHIP_PULP || PULP_CHIP == CHIP_PULP_V1 || PULP_CHIP == CHIP_VEGA || PULP_CHIP == CHIP_GAP9
...
#elif PULP_CHIP == CHIP_ARNOLD
#define __RT_FREQ_DOMAIN_FC 2
#define __RT_FREQ_DOMAIN_CL 0
...
/// @cond IMPLEM
  ...
  #if PULP_CHIP == CHIP_QUENTIN || PULP_CHIP == CHIP_KERBIN || PULP_CHIP == CHIP_PULP || PULP_CHIP == CHIP_PULP_V1
  #define __RT_FLL_CL 2
  #define __RT_FLL_PERIPH 1
  #define __RT_FLL_FC 0
  #elif PULP_CHIP == CHIP_ARNOLD
  #define __RT_FLL_CL 0
  #define __RT_FLL_PERIPH 1
  #define __RT_FLL_FC 2
  #elif PULP_CHIP == CHIP_PULPISSIMO || PULP_CHIP == CHIP_PULPISSIMO_V1
  #define __RT_FLL_CL 2
  #define __RT_FLL_PERIPH 1
  #define __RT_FLL_FC 0
